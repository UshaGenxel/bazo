        ...
        <div class="modal-content">
            ...
            <div id="login-form-wrapper" class="form-wrapper">
                <div class="text-center">
                    <img src="https://placehold.co/60x60/918ef0/ffffff?text=BAZO" alt="BAZO Logo" class="mx-auto mb-4 rounded-full">
        ...
        <div class="modal-content">
            ...
            <div id="forgot-password-wrapper" class="form-wrapper">
                <div class="text-center">
                    ...
                    <p class="text-sm text-gray mt-2"><?php echo esc_html__( 'Enter your email to receive a reset link.', 'bazo' ); ?></p>
